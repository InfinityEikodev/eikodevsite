                            ...
                            <div className='flex justify-center pt-5 not-prose'>
                                <div className='w-[22rem] md:w-[70rem] md:h-[520px]'>
                                    <div className='flex flex-row justify-center'>
                                        <div className='color flex flex-row rounded-3xl h-[520px] text-left min-w-[1120px max-w-[1120px] gradiant-color relative overflow-hidden' style={{}} >
                                            <div className='p-8'>
                                                <h1 className='font-syne font-bold text-4xl md:text-5xl pb-5'>Lobinho WebSite</h1>
                                                <p className='text-base mb-4 md:text-lg'>website made for your project if it is bot for discord!</p>
                                                <p className='text-base mb-4 md:text-lg'>this open project and a website made by me for discord bot owners to make their work easier this open project is a website made by me for discord bot owners to make their work easier, fully modifiable for your own resources!.</p>
                                                <h3 className='font-bold text-xl pt-5 mb-2'>Technologies</h3>
                                                <div className='flex flex-row'>
                                                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="35px" height="35px"><title>HTML5</title><path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"/><path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z"/><path fill="#FFF" d="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"/><path fill="#EEE" d="M24,30.9v4.2l-7.9-2.6L15.7,27h4l0.2,2.5L24,30.9z M19.1,17H24v-4h-9.1l0.7,12H24v-4h-4.6L19.1,17z"/></svg>
                                                </div>
                                                <div className='flex flex-col font-bold pt-8'>
                                                    <a href="https://github.com/InfinityEikodev/lobinhowebsite" className='mr-10'>
                                                        Github
                                                        <svg width="24" height="24" className="inline h-4 w-4" style={{ stroke: "white" }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 13V19C18 19.5304 17.7893 20.0391 17.4142 20.4142C17.0391 20.7893 16.5304 21 16 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V8C3 7.46957 3.21071 6.96086 3.58579 6.58579C3.96086 6.21071 4.46957 6 5 6H11" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M15 3H21V9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M10 14L21 3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                                                    </a>
                                                </div>
                                            ...
                                            <div className='absolute right-0 -z-10' >
                                                <img src="/lobowebsite.png" alt="" className='hidden object-cover w-full md:inline md:h-full md:rounded-r-3xl opacity-10' />
                                            </div>
